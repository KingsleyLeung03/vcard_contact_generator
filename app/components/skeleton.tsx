export function ContactCardSkeleton() {
  return (
    <div className="min-h-80 bg-white dark:bg-neutral-800 rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 animate-pulse mb-8">
      {/* Image Placeholder */}
